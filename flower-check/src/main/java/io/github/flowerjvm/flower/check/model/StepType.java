...
/**
 * A class identified as a Flower Step: it extends {@code Step} or
 * {@code DurableStep} (directly, transitively within the source set, or via a
 * configured base class name).
 *
...
public final class StepType {
    ...
    /** Subset of: onEnter, onTick, onExit, onReset, onResume. */
