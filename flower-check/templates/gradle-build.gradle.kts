...
dependencies {
    flowerCheck("io.github.parkkevinsb.flower:flower-check:$flowerCheckVersion")
    compileOnly("io.github.parkkevinsb.flower:flower-check-annotations:$flowerCheckVersion")
}
...
tasks.register<JavaExec>("flowerCheck") {
    ...
    mainClass.set("io.github.parkkevinsb.flower.check.cli.FlowerCheckCli")
    onlyIf {
